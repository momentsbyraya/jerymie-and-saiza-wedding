...
const Calendar = () => {
  ...
  return (
    <div className={`w-full max-w-md mx-auto px-4 py-8 ${themeConfig.calendar.background}`}>
      {/* Invitation Text */}
...
<div className={`text-center mb-4 ${themeConfig.calendar.headerColor}`}>
      ...
      <div className="relative mt-12 mb-8 h-48 flex justify-center items-center">
        {/* Back Photo - More tilted left */}
        <div className="absolute -top-4 -left-6 w-36 h-44 bg-white shadow-lg transform -rotate-12 opacity-90">
        ...
        <div className="relative w-36 h-44 bg-white shadow-xl transform rotate-3 hover:scale-105 transition-transform duration-300">
        ...
        <div className="absolute -top-2 -right-6 w-32 h-40 bg-white shadow-lg transform rotate-6 ">
