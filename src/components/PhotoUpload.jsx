            ...
            <div className="mx-auto upload-stack flex flex-col items-center justify-center gap-6">
              ...
              {(hashtag1 || showHashtag2) && (
                <div className="text-center">
                  {hashtag1 && (
                    <p className="text-sm sm:text-base font-poppins font-semibold whitespace-nowrap" style={{ color: '#C46A3A' }}>
                      {hashtag1}
                    </p>
                  )}
                  {showHashtag2 && (
              ...
              {hasUploadLink ? (
                <a
                  ...
                  className="w-full max-w-xs inline-flex items-center justify-center gap-2 px-8 py-3 sm:py-5 lg:py-2 bg-white text-[#2F2F2F] rounded-sm text-sm sm:text-2xl lg:text-base font-medium transition-colors duration-200 hover:opacity-90"
                >
                  Upload Photos
                  <ArrowRight className="w-4 h-4" style={{ color: '#2F2F2F' }} />
                </a>
              ) : (
                <span className="w-full max-w-xs inline-flex items-center justify-center gap-2 px-8 py-3 sm:py-5 lg:py-2 bg-white/70 text-[#2F2F2F] rounded-sm text-sm sm:text-2xl lg:text-base font-medium opacity-60 cursor-not-allowed">
                  Upload Photos
                  <ArrowRight className="w-4 h-4" style={{ color: '#2F2F2F' }} />
                </span>
              )}
